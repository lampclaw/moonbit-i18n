...
`0.1.0-rc.1` 以一个模块发布 runtime、generator 与可移植 `moonx` CLI。生成的应用
...
`moon add --bin lampclaw/i18n@0.1.0-rc.1` 是可选的项目级二进制依赖，并非
主流程。也可用
`moon install lampclaw/i18n/cmd/i18n@0.1.0-rc.1` 全局安装，命令名为
`moon-i18n`。
